...
def main(args):
    ...
    # runner.restore("/MountPoint/mat/scripts/results/football/academy_counterattack_hard/pmat/single/run1/models/transformer_1500.pt", "/MountPoint/mat/scripts/results/football/academy_counterattack_hard/pmat/single/run1/models/enc_help_transformer_1500.pt")
    runner.run()
    # runner.eval(0, True)
